    ...
    class musteriKayit
    {
        ...
        public void kayitAl(string adi, string soyadi, string cinsiyet, string telefonNo, string mail, string tcNo, string odaAdi, string ucret, DateTime giris, DateTime cikis)
        {
            ...
            try
            {
                ...
                System.Windows.Forms.MessageBox.Show("Müşteri kaydı başarılı bir şekilde oluşmuştur.","Bilgi", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Information);
                kayit_Al.Dispose();
                //////////////////////////////////
